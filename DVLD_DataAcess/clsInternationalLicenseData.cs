    ...
    public class clsInternationalLicenseData
    {
        ...
        public static DataTable GetDriverInternationalLicenses(int DriverID)
        {
            ...
            string query = @"
                                          ...
                                          InternationalLicenses.ApplicationID, Licenses.LicenseID, InternationalLicenses.IssueDate,
                                            InternationalLicenses.ExpirationDate, InternationalLicenses.IsActive
                                             FROM    InternationalLicenses INNER JOIN Drivers ON InternationalLicenses.DriverID = Drivers.DriverID INNER JOIN
                                    Licenses ON InternationalLicenses.IssuedUsingLocalLicenseID = Licenses.LicenseID AND Drivers.DriverID = Licenses.DriverID
                                           where Drivers.DriverID=@DriverID  order by ExpirationDate desc ";
