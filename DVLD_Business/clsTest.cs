...
namespace DVLD_Business
{
    public class clsTest
    {
        ...
        public static clsTest FindByAppoinmentID(int AppoinmentID)
        {
            int TestID = -1;
            bool TestResult = false; string Notes = ""; int CreatedByUserID = -1;

            if (clsTestData.GetTestInfoByAppoinmentID(AppoinmentID,
            ref TestID, ref TestResult,
            ref Notes, ref CreatedByUserID))

                return new clsTest(TestID,
                        AppoinmentID, TestResult,
                        Notes, CreatedByUserID);
            else
                return null;
        ...
        static public int GetTotalTrialsForTakeTest(int TestTypeID, int LocalDrivingLicenseApplicationID)
        {
            return clsTestData.GetTotalTrialsForTakeTest(TestTypeID, LocalDrivingLicenseApplicationID);
        }
        ...
        public static bool IsPassedTest(int Appoinment)
        {
            return clsTestData.IsPassedTest(Appoinment);    
        }
    }
}
