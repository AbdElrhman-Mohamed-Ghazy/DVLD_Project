...
namespace DVLD.Applications.Realse_Loal_Licence
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        public frmReleaseDetainedLicenseApplication(int LicenceID)
        {
            InitializeComponent();
            _LicenseID = LicenceID;    
            ctrlDriverLicenseInfoWithFilter1.LoadLicenseInfo(LicenceID);
        ...
        private void _Loadinfo()
        {
            ...
            lblApplicationFees.Text = clsApplicationTypes.FindApp((int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicsense).ApplicationFees.ToString();
        ...
        private void btnRelease_Click(object sender, EventArgs e)
        {
            ...
            bool IsReleased = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.ReleaseDetainedLicense(
                 clsUsers.FindByUserName(Properties.Settings.Default.UserName).UserID, ref ApplicationID); 
